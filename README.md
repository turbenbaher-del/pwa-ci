...
### Вход:
Логин и пароль — ваши учётные данные ДБО Центр-инвеста. Приложение их не хранит:
проверку выполняет прокси, у которого креды заданы в переменных окружения
(`DBO_LOGIN`, `DBO_PASSWORD`). В коде и в этом файле учётных данных быть не должно.

### Демо-режим:
Кнопка «Войти в демо-режиме» открывает интерфейс на тестовых данных,
без обращения к банку.
